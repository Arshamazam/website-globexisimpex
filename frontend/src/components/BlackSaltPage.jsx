...
/**
 * Black Salt varieties page (single Black shade × 4 grades).
 * Linked from the Black Salt card on HimalayanEdibleSaltPage.
 * Hash route: "#/black-salt".
 */
...
const SHADE_GROUPS = [
    {
        shade: "Black",
        anchor: "black",
        intro: "Kiln-fired Kala Namak — bold, sulfurous, and mineral-dense. A chef-favorite finishing salt for South Asian cuisine and specialty blends.",
        tint: "from-[#f3f4f6] via-white to-[#e5e7eb]",
        accent: "bg-[#2b2b2b]",
        dot: "bg-[#1a1a1a]",
        products: [
            { name: "Black Salt Chunks", sizeUnit: "cm", size: "2 – 5", img: "/img/Black Salt Chunks.png" },
            { name: "Black Salt Granules", sizeUnit: "mm", size: "2 – 5", img: "/img/Black Salt Granules.png" },
            { name: "Black Salt Coarse", sizeUnit: "mm", size: "1 – 2", img: "/img/Black Salt Coarse  (2).png" },
            { name: "Black Salt Fine", sizeUnit: "Mesh", size: "20 – 50", img: "/img/Black Salt Fine.png" },
        ],
    },
];
    ...
    return (
        <div className="bg-gradient-to-b from-slate-50 via-white to-slate-50 min-h-screen pb-24">
            ...
            <section className="relative bg-gradient-to-br from-brand-navy via-[#002a56] to-brand-navy text-white pt-40 pb-20 overflow-hidden">
                ...
                <div className="absolute -top-20 -right-20 w-96 h-96 bg-black/30 rounded-full blur-3xl pointer-events-none" />
                ...
                <div className="container mx-auto px-6 lg:px-20 max-w-7xl relative z-10">
                    ...
                    <div className="flex items-center gap-3 text-white/40 font-sans uppercase tracking-[0.3em] text-[10px] mb-6">
                        ...
                        <span className="text-white/20">/</span>
                        <span className="text-brand-gold">Black Salt</span>
                    </div>

                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-black leading-none">
                        Black <span className="text-brand-gold italic">Salt</span> Varieties
                    </h1>
                    <p className="text-white/60 font-sans font-light mt-8 max-w-2xl text-lg leading-relaxed">
                        Four edible grades of authentic Kala Namak — kiln-fired, mineral-rich Himalayan black salt for gourmet brands, chefs, and specialty spice blends.
                    </p>
            ...
            <section className="container mx-auto px-6 lg:px-20 max-w-7xl mt-24">
                ...
                >
                    ...
                    <div className="absolute -top-24 -left-24 w-80 h-80 bg-black/40 rounded-full blur-3xl pointer-events-none" />
                    ...
                    <div className="relative z-10 grid grid-cols-1 lg:grid-cols-[1.3fr_1fr] gap-10 p-10 md:p-16 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-5xl lg:text-6xl font-serif font-black leading-[1.05] mt-5">
                                Ready to import <br />
                                <span className="text-brand-gold italic">Himalayan Black Salt?</span>
                            </h2>
