...
/**
 * Pink Salt varieties page (Light / Medium / Dark pink × 4 grades).
 * Linked from the Pink Salt card on HimalayanEdibleSaltPage.
 * Hash route: "#/pink-salt".
 */
...
const SHADE_GROUPS = [
    {
        shade: "Light Pink",
        anchor: "light",
        intro: "Delicate blush tones — the mildest Himalayan hue, ideal for refined table salt and premium retail lines.",
        tint: "from-[#fff4f4] via-white to-[#fdeaea]",
        accent: "bg-[#f9d9d9]",
        dot: "bg-[#f2b8b8]",
        products: [
            { name: "Salt Chunks", sizeUnit: "cm", size: "2 – 5", img: "/img/pink Salt Chunks .png" },
            { name: "Salt Granules", sizeUnit: "mm", size: "2 – 5", img: "/img/Salt Granules .png" },
            { name: "Coarse Salt", sizeUnit: "mm", size: "1 – 2", img: "/img/Coarse Salt.png" },
            { name: "Fine Salt", sizeUnit: "Mesh", size: "20 – 50", img: "/img/Fine Salt Light pink.png" },
        ],
    },
    {
        shade: "Medium Pink",
        anchor: "medium",
        intro: "The classic Himalayan pink — the balanced mid-tone that defines the category worldwide.",
        tint: "from-[#fde6e6] via-white to-[#f9d0d0]",
        accent: "bg-[#f3b6b6]",
        dot: "bg-[#e28b8b]",
        products: [
            { name: "Salt Chunks", sizeUnit: "cm", size: "2 – 5", img: "/img/Salt Chunks Medium pink.png" },
            { name: "Salt Granules", sizeUnit: "mm", size: "2 – 5", img: "/img/Salt Granules Medium pink.png" },
            { name: "Coarse Salt", sizeUnit: "mm", size: "1 – 2", img: "/img/Coarse Salt Medium pink.png" },
            { name: "Fine Salt", sizeUnit: "Mesh", size: "20 – 50", img: "/img/Fine Salt Medium pink.png" },
        ],
    },
    {
        shade: "Dark Pink",
        anchor: "dark",
        intro: "A deeper, mineral-rich rose — sought after for gourmet applications and specialty spice blends.",
        tint: "from-[#fcd8d8] via-white to-[#f5b2b2]",
        accent: "bg-[#e89797]",
        dot: "bg-[#b85e5e]",
        products: [
            { name: "Salt Chunks", sizeUnit: "cm", size: "2 – 5", img: "/img/Salt Chunks Dark pink.png" },
            { name: "Salt Granules", sizeUnit: "mm", size: "2 – 5", img: "/img/Salt Granules Dark pink.png" },
            { name: "Coarse Salt", sizeUnit: "mm", size: "1 – 2", img: "/img/Coarse Salt Dark  pink.png" },
            { name: "Fine Salt", sizeUnit: "Mesh", size: "20 – 50", img: "/img/Fine Salt Dark pink.png" },
        ],
    },
];
            ...
            <section className="relative bg-gradient-to-br from-brand-navy via-[#002a56] to-brand-navy text-white pt-40 pb-20 overflow-hidden">
                ...
                <div className="container mx-auto px-6 lg:px-20 max-w-7xl relative z-10">
                    ...
                    <div className="flex items-center gap-3 text-white/40 font-sans uppercase tracking-[0.3em] text-[10px] mb-6">
                        ...
                        <span className="text-white/20">/</span>
                        <span className="text-brand-gold">Pink Salt</span>
                    </div>

                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-black leading-none">
                        Pink <span className="text-brand-gold italic">Salt</span> Varieties
                    </h1>
                    <p className="text-white/60 font-sans font-light mt-8 max-w-2xl text-lg leading-relaxed">
                        Three signature shades, four edible grades each — twelve finely tuned Himalayan pink salts for every brand, kitchen, and market.
                    </p>
                    ...
                    <div className="relative z-10 grid grid-cols-1 lg:grid-cols-[1.3fr_1fr] gap-10 p-10 md:p-16 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-5xl lg:text-6xl font-serif font-black leading-[1.05] mt-5">
                                Ready to import <br />
                                <span className="text-brand-gold italic">Himalayan Pink Salt?</span>
                            </h2>
                            <p className="text-white/60 font-sans font-light mt-6 max-w-xl leading-relaxed">
                                Send us your target volume, preferred shade, grade, and packing — we reply with a tailored FOB/CIF quotation and full lab documentation within one business day.
                            </p>
 ...
 * Each panel has its own tinted gradient + bold vertical shade label on the left.
 */
 ...
 * Deliberately different from the reference's vertical stacked layout.
 */
